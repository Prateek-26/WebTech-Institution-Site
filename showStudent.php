                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="./index.php"
                                    style="color: #fff; text-shadow: 0 #fff;">Home</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="./campus.html"
                                            style="color: black; text-shadow: 0 0;">Campus</a></li>
                                    <li><a class="dropdown-item" href="./Library.html"
                                            style="color: black; text-shadow: 0 0;">Library</a></li>
                                    <li><a class="dropdown-item" href="./students.html"
                                            style="color: black; text-shadow: 0 0;">Students</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#"
                                            style="color: black; text-shadow: 0 0;">Director</a></li>
                                    <li><a class="dropdown-item" href="#"
                                            style="color: black; text-shadow: 0 0;">HODs</a></li>
                                    <li><a class="dropdown-item" href="#" style="color: black; text-shadow: 0 0;">Key
                                            Faculty</a></li>
                                </ul>
                            </li>
        ...
        <div>
            <div class="faculty_details">
                ...
                <div class="faculty_info">
                    <div class="faculty_name">Falana Dimkana</div>
                    <div class="faculty_designation">Area-51 Ufo Researcher</div>
                    <div class="faculty_bio">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
